...
import medallas from '../Img/image.png';
...
function Bienvenida (){
    ...
    return(
        ...
        <div className="contenido">
            ...
            <button onClick={()=> navigate ('/countries')} className="jaja">Countries</button>
            <button onClick={()=> navigate ('/disciplines')} className="jaja">Disciplines</button>
        </div>
        </div>
